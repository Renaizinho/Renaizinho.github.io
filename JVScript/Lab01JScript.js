...
const botao1 = document.querySelector(".EXEC1")
...
botao1.addEventListener("click", () => {
    const num1 = obtemValor("#Q1V1")

    escreveValor("#res1", fatorial(num1))
})

const botao2 = document.querySelector(".EXEC2")
...
botao2.addEventListener("click", () => {
    escreveValor("#res2", pot04())
})


const botao3 = document.querySelector(".EXEC3")
...
botao3.addEventListener("click", () => {
    escreveValor("#res3", somaPares())
})

const botao4 = document.querySelector(".EXEC4")
...
botao4.addEventListener("click", () => {
    escreveValor("#res4", fibo())
})


const botao5 = document.querySelector(".EXEC5")
